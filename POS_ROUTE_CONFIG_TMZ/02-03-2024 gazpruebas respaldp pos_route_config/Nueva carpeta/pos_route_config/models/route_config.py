...
class reporte_s(models.Model): #esta almacena los datos
    ...
    state = fields.Selection(string='Estatus', default='new',
        selection=[('new', 'New'), 
                   ...
                   ('reception', 'Route Reception'), 
                   ('concil', 'Sale Conciliation'), 
                   ('finish', 'Cash Box Closed')])#state = fields.Char(string='Estatus', default='new')
    
        # selection=[('nuevo', 'Nuevo'), 
        #            ('Comenzar', 'Configuración de Ruta'), 
        #            ('venta', 'Ventas'), 
        #            ('recepción', 'Recepción de rutas'), 
        #            ('concilio', 'Conciliación de venta'), 
        #            ('finalizado', 'Cierre de caja')]) 
