...
class reporte_s(models.Model): #este almacena los datos--
    ...
    #fecha_reporte = fields.Date(string='Fecha  reporteJ: ', default=fields.Date.today())#NO

    #route_config_id = fields.Many2one(string='Route configuration', comodel_name='pos_route_config.route_config')#NO
