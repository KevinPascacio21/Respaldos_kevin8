...
class RC_report(models.Model): 
    _name = 'pos_route_config.RC_report'
    _description = 'reportes'

    fecha_filtro = fields.Date(string='Fecha')

    relacion_ids = fields.Many2many(comodel_name='pos_route_config.reporte_s',  inverse_name='data_ids', string='Relacion')
    ...
    def _get_name(self): 
        for doc in self:
            if doc.fecha_filtro:
                ...
                for res in rec:
                    line = {}
                    line['Fecha de creación'] = res.arrival_date
                    line['Referencia de ruta'] = res.route_config_id
                    ...
                    line['Peso inicial'] = res.st_weight_aux
                    ...
                    line['Promedio general'] = res.hg_avg #promedio general hg_avg
                    ...
                    line['Litros a cobrar'] = res.liters_receivable
                    line['Litros para pagar'] = res.refuel_liters
...
class reporte_s(models.Model): #esta almacena los datos
    _name = 'pos_route_config.reporte_s'
    _description = 'Almacen de datos'

    data_ids = fields.Many2one(comodel_name='pos_route_config.RC_report', string='Variables', readonly=True)# 
