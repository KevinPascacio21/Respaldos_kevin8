...
#Heredo los campos de sale order(contact center) y en caso de que sean editados, que se muestren en la seccion de abajo
    ...
    # date_order = fields.Datetime(tracking=True) #(string="Fecha de la orden") BIEN
    # pricelist_id = fields.Many2one(tracking=True) #(string="Lista de precios") BIEN
    # payment_term_id = fields.Many2one(tracking=True) #(string="Terminos de pago") BIEN
    # pricelist_id = fields.Many2one(tracking=True) #(string="Lista de precios") BIEN
    # date_order = fields.Datetime(tracking=True) #(string="Fecha de la orden") BIEN
    # pricelist_id = fields.Many2one(tracking=True) #(string="Lista de precios") BIEN
    # payment_term_id = fields.Many2one(tracking=True) #(string="Terminos de pago") BIEN
