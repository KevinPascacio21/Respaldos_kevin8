...
#Heredo los campos de sale order(contact center) y en caso de que sean editados, que se muestren en la seccion de abajo
    ...
    x_studio_punto_de_venta = fields.Many2one(comodel_name='pos.config', tracking=True) #
    x_studio_punto_de_venta_1 = fields.Many2one(comodel_name='pos.config', tracking=True)
    # punto_de_venta = fields.Many2one(string="Punto de ventasx", readonly="1", tracking=True)
